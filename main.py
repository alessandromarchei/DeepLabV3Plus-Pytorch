...
def get_argparser():
    ...
    # Datset Options
    parser.add_argument("--data_root", type=str, default='/home/sergey/DEV/AI/datasets/cityscapes/',
    ...
    parser.add_argument("--lr_backbone_coeff", type=float, default=0.1,
                        help="learning rate multiplier for backbone (default: 0.1)") 
